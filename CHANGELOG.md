...
### Fixed
- SOAP: Circumvent `zeep` closing the underlying client after the first request

### Changed
- Update dependencies, including major version bump of `authlib` and `ipython`

### Removed
- Remove `session` parameter to NetSuiteSoapApi
